MEMORY
{
   ...
   RAMLS4           : origin = 0x00009800, length = 0x00000800
   RAMLS5           : origin = 0x0000A000, length = 0x00001800
   RAMLS6           : origin = 0x0000B800, length = 0x00000800
...
SECTIONS
{
   ...
   .text            : >>FLASH_BANK0_SEC2 | FLASH_BANK0_SEC3 | FLASH_BANK0_SEC4 | FLASH_BANK0_SEC6 | FLASH_BANK0_SEC7 | FLASH_BANK0_SEC8 | FLASH_BANK0_SEC9 | FLASH_BANK0_SEC10 | FLASH_BANK0_SEC11, ALIGN(4)
   ...
   .bss             : > RAMLS5 | RAMGS2 | RAMGS3
   .bss:output      : > RAMLS5 | RAMGS2 | RAMGS3
   .bss:cio         : > RAMLS5
   .data            : > RAMLS6
   .sysmem          : > RAMLS6
   .const           : > FLASH_BANK0_SEC12       ALIGN(4)
#else
   .pinit           : > FLASH_BANK0_SEC1       ALIGN(4)
   .ebss            : >>RAMLS5 | RAMLS6
   .esysmem         : > RAMLS6
   .cio             : > RAMLS5
   .econst          : > FLASH_BANK0_SEC12
#endif
   ...
   dclfuncs         : > FLASH_BANK0_SEC1,     ALIGN(4)
    ...
    Cla1Prog        : LOAD = FLASH_BANK0_SEC12,
                      RUN = RAMLS0,
